...
public class FLOODException extends Exception {
	...
	public static FLOODException InvalidFunctionReturnType(int lineInfo, String element) throws FLOODException{
		FLOODException e = new FLOODException(lineInfo, "At line: " + lineInfo + ", " + element + " invalid return ");
		return e;
	}
